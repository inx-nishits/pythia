...
const faqs = [
  ...
  },
  {
    ...
    a: "Privacy is our core foundation. All audio is processed locally on the hardware device using Edge AI. No customer voice recordings or Personally Identifiable Information (PII) are ever stored or transmitted to the cloud."
  },
  {
          ...
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                ...
                <div
                  className={`w-8 h-8 aspect-square rounded-full border border-slate-200 flex-none flex items-center justify-center transition-transform duration-300 ${openIndex === index ? 'rotate-180 bg-brand-teal border-brand-teal' : ''
                    }`}
                >

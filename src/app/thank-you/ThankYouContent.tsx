    ...
    <div className="flex flex-col min-w-0 w-full max-w-[100vw] overflow-x-hidden min-h-screen bg-brand-navy">
      ...
      <main className="flex-grow flex items-center justify-center py-20 px-4 overflow-hidden relative">
        ...
        <div className="relative max-w-2xl w-full text-center">
          ...
          >
            <div className="inline-flex items-center justify-center w-28 h-28 rounded-full bg-brand-teal/10 border border-brand-teal/20 mb-2 relative">
               {/* Ripple effect */}
               <motion.div 
            ...
            <div className="pt-6 flex justify-center">
              <Link href="/">
                <Button className="px-10 py-4 bg-brand-teal text-brand-navy hover:bg-brand-teal-hover rounded-full font-bold text-lg shadow-[0_0_20px_rgba(20,184,166,0.3)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_0_30px_rgba(20,184,166,0.5)]">
                  Return to Home
                </Button>
              </Link>
            </div>
